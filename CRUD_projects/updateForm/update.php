...
<body>
    <div class="container">
        <h1 class="text-center">Actualizar Parametros del Alumno</h1>
        <form action="../CRUD/edit_project.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nombreAlumnos" name="nombreAlumnos" placeholder="José*" value="<?= $row['nombreAlumnos']?>">
            </div>
            <div class="form-group">
                <label for="edad">Edad</label>
                <input type="number" class="form-control" id="edad" name="edad" placeholder="19*" value="<?= $row['edad']?>">
            </div>
